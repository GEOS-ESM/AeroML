#!/usr/bin/env python3
"""
    Validate the Deep Blue Deep Obs
"""

import os, sys
from   pyabc.abc_viirs         import ABC_DB_Deep
...
if __name__ == "__main__":
    ...
    figfile = outdir + '/kde2d_dbdeep_std.png'
    _plot2dKDE(targets,original,x_bins=None,y_bins=None,
             x_label='AERONET', y_label='STANDARD Retrieval',figfile=figfile,title='DB-DEEP 550 nm AOD')

    figfile = outdir + '/kde2d_dbdeep_nnr.png'
    _plot2dKDE(targets,results,x_bins=None,y_bins=None,
             x_label='AERONET', y_label='NNR Retrieval',figfile=figfile,title='DB-DEEP 550 nm AOD')
    ...
    if (outliers > 0) and (K is None):
        ...
        figfile = outdir + '/kde2d_dbdeep_outliers_std.png'
        _plot2dKDE(targets,original,x_bins=None,y_bins=None,
             x_label='AERONET', y_label='STANDARD Retrieval',figfile=figfile,title='DB-DEEP 550 nm AOD')

        figfile = outdir + '/kde2d_dbdeep_outliers_nnr.png'
        _plot2dKDE(targets,results,x_bins=None,y_bins=None,
             x_label='AERONET', y_label='NNR Retrieval',figfile=figfile,title='DB-DEEP 550 nm AOD')
